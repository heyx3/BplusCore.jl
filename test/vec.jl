...
# Test vequal():
@bp_test_no_allocations(vequal(2, 2), true)
@bp_test_no_allocations(vequal(3, 2), false)
@bp_test_no_allocations(vequal(UInt8(3), 3.0), true)
@bp_test_no_allocations(vequal(2.5, 2), false)
@bp_test_no_allocations(vequal(v1f(2), v1f(2)), v1b(true))
@bp_test_no_allocations(vequal(v1f(3), v1f(2)), v1b(false))
@bp_test_no_allocations(vequal(2, v1f(2)), v1b(true))
@bp_test_no_allocations(vequal(v1f(2), 2), v1b(true))
@bp_test_no_allocations(vequal(v1f(2), v2f(1, 3)), v2b(false, false))
@bp_test_no_allocations(vequal(v1f(2), v2f(1, 2)), v2b(false, true))
@bp_test_no_allocations(vequal(v1f(2), v2f(2, 3)), v2b(true, false))
@bp_test_no_allocations(vequal(v1f(2), v2f(2, 2)), v2b(true, true))
@bp_test_no_allocations(vequal(2, v2f(1, 3)), v2b(false, false))
@bp_test_no_allocations(vequal(2, v2f(1, 2)), v2b(false, true))
@bp_test_no_allocations(vequal(2, v2f(2, 3)), v2b(true, false))
@bp_test_no_allocations(vequal(2, v2f(2, 2)), v2b(true, true))
@bp_test_no_allocations(vequal(v2f(1, 3), v1f(2)), v2b(false, false))
@bp_test_no_allocations(vequal(v2f(1, 2), v1f(2)), v2b(false, true))
@bp_test_no_allocations(vequal(v2f(2, 3), v1f(2)), v2b(true, false))
@bp_test_no_allocations(vequal(v2f(2, 2), v1f(2)), v2b(true, true))
@bp_test_no_allocations(vequal(v2f(1, 3), 2), v2b(false, false))
@bp_test_no_allocations(vequal(v2f(1, 2), 2), v2b(false, true))
@bp_test_no_allocations(vequal(v2f(2, 3), 2), v2b(true, false))
@bp_test_no_allocations(vequal(v2f(2, 2), 2), v2b(true, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(1, 2, 3)), v3b(true, true, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(2, 2, 3)), v3b(false, true, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(1, 1, 3)), v3b(true, false, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(1, 2, 4)), v3b(true, true, false))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(2, 1, 3)), v3b(false, false, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(2, 1, 3)), v3b(false, false, true))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(2, 2, 4)), v3b(false, true, false))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(1, 1, 1)), v3b(true, false, false))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(2, 2, 2)), v3b(false, true, false))
@bp_test_no_allocations(vequal(v3f(1, 2, 3), v3f(3, 3, 3)), v3b(false, false, true))
